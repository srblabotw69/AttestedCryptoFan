...
export function Header() {
  ...
  if (address) {
    menuItems.push({
      title: "Connections",
      onClick: () => navigate("/attestedCryptoFan/connections"),
      path: "/connections",
    });
  }
    ...
    <>
      <Outer>
        <Container>
          <MainNavigation>
            <LogoContainer>
              <Logo onClick={() => navigate("/attestedCryptoFan")}>
                {/* <LogoImage src="/logo.png" /> */}
                <LogoText>Attested Crypto Fan</LogoText>
              ...
              <Links>
                {address && (
                  <QR
                    size={20}
                    color={"#BD9EFF"}
                    onClick={() => navigate("/attestedCryptoFan/qr")}
                  />
                )}
